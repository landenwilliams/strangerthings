...
const LogIn = (props) => {
    ...
    return (
        ...
        <div id="logintable">
            ...
            <form id="login-form">
                <input type="text" name="username" placeholder="username" onChange={() => {setLoginName(event.target.value)}}/>
                <input type="password" name="password" placeholder="password" onChange={() => {setLoginPassword(event.target.value)}}></input>
                {
                    showLoginButton ? 
                        <>
                            ...
                            <input type="password" name="confirm" placeholder="confirm password" onChange={() => {setConfirmPassword(event.target.value)}}></input>
